...
toggleButton.Size = UDim2.new(0, 50, 0, 50)  -- ขนาดของปุ่มเล็กลงเป็น 50x50
toggleButton.Position = UDim2.new(0, 10, 0.5, -25)  -- ตำแหน่งซ้ายกลาง
toggleButton.Text = "เปิด/ปิด การเก็บของ"
toggleButton.TextSize = 12  -- ขนาดตัวอักษรลดลง
...
corner.CornerRadius = UDim.new(0, 25)  -- กำหนดมุมให้เป็นวงกลม (ครึ่งหนึ่งของขนาดปุ่ม)
