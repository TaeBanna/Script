...
function Collection:GetEntities(Entities) -- Param of "Entities" is a table
...
-- 🔒 ฟังก์ชันสำหรับแช่ผู้เล่นไว้ 1 วินาที
function Collection:FreezePlayerFor(seconds)
    local RootPart = self:GetRoot(LocalPlayer.Character)
    if RootPart then
