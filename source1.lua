...
-- Minimal, mobile-friendly theme for Banna Hub
local themes = {
    SchemeColor = Color3.fromRGB(0, 120, 215), -- Blue accent
    Background = Color3.fromRGB(255, 255, 255), -- White background
    Header = Color3.fromRGB(240, 240, 240), -- Light gray header
    TextColor = Color3.fromRGB(30, 30, 30), -- Dark text
    ElementColor = Color3.fromRGB(230, 230, 230) -- Light gray for elements
}
local themeStyles = {
    DarkTheme = {
...
function Kavo.CreateLib(kavName, themeList)
    kavName = "Banna Hub" -- Always use Banna Hub as the name
    themeList = themes -- Always use the simple theme

    -- ปรับขนาด UI ให้เหมาะกับมือถือ
    local screenW = 400
    local screenH = 500
    ...
    Main.Size = UDim2.new(0, screenW, 0, screenH)
    ...
    MainHeader.Size = UDim2.new(0, screenW, 0, 48)
    ...
    coverup.Size = UDim2.new(0, screenW, 0, 7)
    ...
    MainSide.Size = UDim2.new(0, 120, 1, -48)
    ...
    function Tabs:NewTab(tabName)
        ...
        tabButton.Size = UDim2.new(0, 135, 0, 40)
        ...
        coroutine.wrap(function()
            ...
            function Elements:NewButton(bname,tipINf, callback)
                ...
                buttonElement.Size = UDim2.new(0, 260, 0, 44)
            ...
            function Elements:NewTextBox(tname, tTip, callback)
                ...
                textboxElement.Size = UDim2.new(0, 260, 0, 44)
                ...
                function Elements:NewToggle(tname, nTip, callback)
                    ...
                    toggleElement.Size = UDim2.new(0, 260, 0, 44)
            ...
            function Elements:NewSlider(slidInf, slidTip, maxvalue, minvalue, callback)
                ...
                sliderElement.Size = UDim2.new(0, 260, 0, 44)
            ...
            function Elements:NewKeybind(keytext, keyinf, first, callback)
                ...
                keybindElement.Size = UDim2.new(0, 260, 0, 44)
